...
function FormII() {
  ...
  var photographersSelect = useRef(null);
  var cinematographersSelect = useRef(null);
  var dronesSelect = useRef(null);
  ...
  const handleAddEvent = (e) => {
    ...
    dronesSelect.current.clearValue()
      ...
      <div className="mt18">
            ...
            <Col xs="6" sm="3" className="pr5">
              <div ref={target}>
                <div>
                  ...
                  >
                    {eventValues?.eventDate ? dayjs(eventValues?.eventDate).format('DD-MMM-YYYY') : 'Date'}
                    <img src={CalenderImg} />
                  </div>
                </div>
              </div>
          ...
          <Row>
            <Col xs="4" sm="3" className="pr5">
              <div className='mt25'>
                ...
                <Select ref={photographersSelect} name='photographers' className='w-50' onChange={(selected) => {
                  setEventValues({ ...eventValues, photographers: selected?.value })
            ...
            <Col xs="6" sm="3">
              <div className='mt25'>
                ...
                <Select ref={cinematographersSelect} name='cinematographers' className='w-50' onChange={(selected) => {
                  setEventValues({ ...eventValues, cinematographers: selected?.value })
                }} styles={customStyles} options={numberOptions} required />
              </div>
            </Col>
            <Col xs="6" sm="3">
              <div className='mt25'>
                ...
                <Select ref={dronesSelect} name='drones' className='w-50' onChange={(selected) => {
          ...
          <Row className="mt-2">
            <Col xs="6" sm="3">
              <div className='mt25'>
                ...
                <Select ref={sameDayPhotoEditorsSelect} name='sameDayPhotoEditor' className='w-50' onChange={(selected) => {
                  setEventValues({ ...eventValues, sameDayPhotoEditor: selected?.value })
            ...
            <Col xs="6" sm="3">
              <div className='mt25'>
                ...
                <Select ref={sameDayVideoEditorsSelect} name='sameDayVideoEditor' className='w-50' onChange={(selected) => {
                  setEventValues({ ...eventValues, sameDayVideoEditor: selected?.value })
                }} styles={customStyles} options={yesNoOptions} required />
              </div>
            </Col>
            <Col xs="6" sm="3">
              <div className='mt25'>
                ...
                <Select ref={tentativeSelect} name='tentative' className='w-50' onChange={(selected) => {
                  setEventValues({ ...eventValues, tentative: selected?.value })
                }} styles={customStyles} options={yesNoOptions} required />
              </div>
            </Col>
          </Row>
        ...
        <Form onSubmit={e => {
                  ...
                  return (
                    <Col xs="4" sm="3" key={i}>
                      <div className="Drop">
                        ...
                        <Select value={albumValue?.length > 0 ? { value: albumValue, label: albumValue } : null} name={`album${i + 1}`} className='w-75' onChange={(selected) => {
                          const updatedAlbums = [...clientData?.albums];
                          updatedAlbums[i] = selected?.value;
                          dispatch(updateClintData({ ...clientData, albums: updatedAlbums }))
                          setEventValues({ ...eventValues, albums: selected?.value })
                        }} styles={customStyles}
                          options={[
                            { value: 'RGB', label: 'RGB' },
                            { value: 'CMYK', label: 'CMYK' }]} required={true} />
                      </div>
                    </Col>
                  );
                })}
              ...
              <div className='d-flex fex-row'>
                {clientData?.albums?.length > 1 && (
                  <div style={{
                    ...
                    height: '30px',
                    borderRadius: '100%'
                  }} className='fs-3 mt-4 mx-1 d-flex justify-content-center align-items-center' onClick={() => {
                    const updatedAlbums = [...clientData?.albums];
                    updatedAlbums.pop();
                    dispatch(updateClintData({ ...clientData, albums: updatedAlbums }))
                  }} >
                ...
                <div className='fs-3 mt-4 mx-1 d-flex justify-content-center align-items-center' onClick={addAlbum} style={{
                  backgroundColor: "rgb(102, 109, 255)",
                  color: 'white',
                  width: '30PX',
                  height: '30px',
          ...
          <Row>
            <Col xs="4" sm="2">
              <div className='mt25'>
                ...
                <Select value={clientData?.promos ? { value: clientData?.promos, label: clientData?.promos } : null} name='promos' className='w-75' onChange={(selected) => {
                  dispatch(updateClintData({ ...clientData, promos: selected?.value }))
                }} styles={customStyles} options={yesNoOptions} required />
              </div>
            </Col>
            <Col xs="6" sm="2">
              <div className='mt25'>
                ...
                <Select value={clientData?.longFilms ? { value: clientData?.longFilms, label: clientData?.longFilms } : null} name='longFilms' className='w-75' onChange={(selected) => {
                  dispatch(updateClintData({ ...clientData, longFilms: selected?.value }))
                }} styles={customStyles} options={numberOptions} required />
              </div>
            </Col>
            <Col xs="4" sm="2">
              <div className='mt25'>
                ...
                <Select value={clientData?.reels ? { value: clientData?.reels, label: clientData?.reels } : null} name='reels' className='w-75' onChange={(selected) => {
                  dispatch(updateClintData({ ...clientData, reels: selected?.value }))
                }} styles={customStyles} options={numberOptions} required />
              </div>
            </Col>
            <Col xs="3" sm="2">
              <div className='mt25'>
                ...
                <Select value={clientData?.hardDrives ? { value: clientData?.hardDrives, label: clientData?.hardDrives } : null} name='hardDrives' className='w-75' onChange={(selected) => {
                  dispatch(updateClintData({ ...clientData, hardDrives: selected?.value }))
                }} styles={customStyles} options={numberOptions} required />
              </div>
            </Col>
          </Row>
          ...
          <div className="centerAlign mt40 mb15 ">
            <Button type='button' className="submit_btn submit me-5" onClick={() => {
              navigate('/MyProfile/AddClient/Form-I')
            }}>
              Back
            </Button>
